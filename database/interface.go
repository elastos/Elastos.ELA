...
type Tx interface {
	...
	//
	// Other errors are possible depending on the implementation.
	HasBlock(hash common.Uint256) (bool, error)
	...
	//
	// Other errors are possible depending on the implementation.
	HasBlocks(hashes []common.Uint256) ([]bool, error)
	...
	// implementations.
	FetchBlockHeader(hash *common.Uint256) ([]byte, error)
	...
	// additional data copies and allows support for memory-mapped database
	// implementations.
	FetchBlockHeaders(hashes []common.Uint256) ([][]byte, error)
	...
	// additional data copies and allows support for memory-mapped database
	// implementations.
	FetchBlock(hash *common.Uint256) ([]byte, error)
	...
	// additional data copies and allows support for memory-mapped database
	// implementations.
	FetchBlocks(hashes []common.Uint256) ([][]byte, error)
