...
var (
	...
	// Encodes a .onion address as a 16 byte number by decoding the
...
func IsIPv4(na *p2p.NetAddress) bool {
	return na.IP.To4() != nil
}

// IsLocal returns whether or not the given address is a local address.
func IsLocal(na *p2p.NetAddress) bool {
	return na.IP.IsLoopback() || zero4Net.Contains(na.IP)
}

// IsOnionCatTor returns whether or not the passed address is in the IPv6 range
// used by to support Tor (fd87:d87e:eb43::/48).  Note that this range
// is the same range used by OnionCat, which is part of the RFC4193 unique local
// IPv6 range.
func IsOnionCatTor(na *p2p.NetAddress) bool {
...
func IsRFC1918(na *p2p.NetAddress) bool {
...
func IsRFC2544(na *p2p.NetAddress) bool {
...
func IsRFC3849(na *p2p.NetAddress) bool {
...
func IsRFC3927(na *p2p.NetAddress) bool {
...
func IsRFC3964(na *p2p.NetAddress) bool {
	return rfc3964Net.Contains(na.IP)
}

// IsRFC4193 returns whether or not the passed address is part of the IPv6
// unique local range as defined by RFC4193 (FC00::/7).
func IsRFC4193(na *p2p.NetAddress) bool {
...
func IsRFC4380(na *p2p.NetAddress) bool {
...
func IsRFC4843(na *p2p.NetAddress) bool {
...
func IsRFC4862(na *p2p.NetAddress) bool {
...
func IsRFC5737(na *p2p.NetAddress) bool {
...
func IsRFC6052(na *p2p.NetAddress) bool {
...
func IsRFC6145(na *p2p.NetAddress) bool {
...
func IsRFC6598(na *p2p.NetAddress) bool {
...
func IsValid(na *p2p.NetAddress) bool {
...
func IsRoutable(na *p2p.NetAddress) bool {
...
// address.
func GroupKey(na *p2p.NetAddress) string {
	if IsLocal(na) {
		return "local"
	}
	if !IsRoutable(na) {
	...
	// uses /32 for everything, except for Hurricane Electric's
