...
func (v *TxVersionV1) CheckCoinbaseMinerReward(tx *types.Transaction, totalReward common.Fixed64) error {
	return nil
}

func (v *TxVersionV1) CheckCoinbaseArbitratorsReward(coinbase *types.Transaction, rewardInCoinbase common.Fixed64) error {
	return nil
}
