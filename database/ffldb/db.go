...
type transaction struct {
	...
	pendingBlocks    map[common.Uint256]int
...
func (tx *transaction) hasBlock(hash common.Uint256) bool {
...
func (tx *transaction) StoreBlock(blockHash common.Uint256, data []byte) error {
	...
	if tx.pendingBlocks == nil {
		tx.pendingBlocks = make(map[common.Uint256]int)
	}
...
//
// This function is part of the database.Tx interface implementation.
func (tx *transaction) HasBlock(hash common.Uint256) (bool, error) {
	// Ensure transaction state is valid.
	if err := tx.checkClosed(); err != nil {
		return false, err
	}
...
//
// This function is part of the database.Tx interface implementation.
func (tx *transaction) HasBlocks(hashes []common.Uint256) ([]bool, error) {
	// Ensure transaction state is valid.
	if err := tx.checkClosed(); err != nil {
		return nil, err
	}
...
func (tx *transaction) fetchBlockRow(hash *common.Uint256) ([]byte, error) {
...
//
// This function is part of the database.Tx interface implementation.
func (tx *transaction) FetchBlockHeader(hash *common.Uint256) ([]byte, error) {
...
//
// This function is part of the database.Tx interface implementation.
func (tx *transaction) FetchBlockHeaders(hashes []common.Uint256) ([][]byte, error) {
...
//
// This function is part of the database.Tx interface implementation.
func (tx *transaction) FetchBlock(hash *common.Uint256) ([]byte, error) {
	// Ensure transaction state is valid.
	if err := tx.checkClosed(); err != nil {
		return nil, err
	}
...
//
// This function is part of the database.Tx interface implementation.
func (tx *transaction) FetchBlocks(hashes []common.Uint256) ([][]byte, error) {
	// Ensure transaction state is valid.
	if err := tx.checkClosed(); err != nil {
		return nil, err
	}
