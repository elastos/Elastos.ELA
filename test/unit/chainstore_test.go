...
func TestGenesisBlock(t *testing.T) {
	...
	foundation, _ := common.Uint168FromAddress(mainNetFoundation)
	block := core.GenesisBlock(*foundation)
	...
	foundation, _ = common.Uint168FromAddress(testNetFoundation)
	genesisHash = core.GenesisBlock(*foundation).Hash().String()
