...
const (
	...
	DataDir = "elastos"
	// MainNetCrossChainUTXORestrictionHeight is the coordinated mainnet
	// activation height for the CrossChain UTXO spending restriction.
	MainNetCrossChainUTXORestrictionHeight uint32 = 2256400
