...
// matches the filter.
func (f *NextTurnDPOSInfoFilter) MatchConfirmed(tx *transactions.BaseTransaction) bool {
...
func (f *NextTurnDPOSInfoFilter) MatchUnconfirmed(tx *transactions.BaseTransaction) bool {
