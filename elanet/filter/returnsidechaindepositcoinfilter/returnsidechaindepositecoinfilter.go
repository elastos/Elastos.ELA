...
// matches the filter.
func (f *ReturnSidechainDepositCoinFilter) MatchConfirmed(tx *types.Transaction) bool {
...
func (f *ReturnSidechainDepositCoinFilter) MatchUnconfirmed(tx *types.Transaction) bool {
