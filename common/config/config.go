...
type CRConfiguration struct {
	...
	ChangeSideChainMinGasPriceHeight uint32 `screw:"--changesidechainmingaspriceheight" usage:"defines the height to use CR proposal to change gas price of side chain"`
}
