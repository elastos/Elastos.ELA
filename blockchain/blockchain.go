...
func (b *BlockChain) CreateCRCAppropriationTransaction() (interfaces.Transaction, Fixed64, error) {
	utxos, lockedAmount, err := b.getUTXOsFromAddress(*b.chainParams.CRConfiguration.CRAssetsAddressUint168)
	if err != nil {
		return nil, 0, err
	}
	...
	outputs := []*common.OutputInfo{{*b.chainParams.CRConfiguration.CRExpensesAddressUint168,
		appropriationAmount}}

	tx, err := b.createTransaction(&payload.CRCAppropriation{}, common.CRCAppropriation,
		*b.chainParams.CRConfiguration.CRAssetsAddressUint168, Fixed64(0), uint32(0), utxos, outputs...)
	if err != nil {
		return nil, 0, err
	}
...
func (b *BlockChain) CreateDposV2RealWithdrawTransaction(
	...
	utxos, _, err := b.getUTXOsFromAddress(*b.chainParams.DPoSConfiguration.DPoSV2RewardAccumulateAddressUint168)
	if err != nil {
		return nil, err
	}
	...
	tx, err = b.createTransaction(wPayload, common.DposV2ClaimRewardRealWithdraw,
		*b.chainParams.DPoSConfiguration.DPoSV2RewardAccumulateAddressUint168, txFee, uint32(0), utxos, outputs...)
	if err != nil {
		return nil, err
	}
	return tx, nil
...
func (b *BlockChain) CreateVotesRealWithdrawTransaction(
	...
	utxos, _, err := b.getUTXOsFromAddress(*b.chainParams.StakePoolUint168)
	if err != nil {
		return nil, err
	}
	...
	tx, err = b.createTransaction(wPayload, common.VotesRealWithdraw,
		*b.chainParams.StakePoolUint168, txFee, uint32(0), utxos, outputs...)
	if err != nil {
		return nil, err
	}
	return tx, nil
...
func (b *BlockChain) CreateCRRealWithdrawTransaction(
	withdrawTransactionHashes []Uint256, outputs []*common.OutputInfo) (interfaces.Transaction, error) {
	utxos, _, err := b.getUTXOsFromAddress(*b.chainParams.CRConfiguration.CRExpensesAddressUint168)
	if err != nil {
		return nil, err
	}
	...
	tx, err := b.createTransaction(wPayload, common.CRCProposalRealWithdraw,
		*b.chainParams.CRConfiguration.CRExpensesAddressUint168, txFee, uint32(0), utxos, outputs...)
	if err != nil {
		return nil, err
	}
	return tx, nil
...
func (b *BlockChain) CreateCRAssetsRectifyTransaction() (interfaces.Transaction, error) {
	utxos, _, err := b.getUTXOsFromAddress(*b.chainParams.CRConfiguration.CRAssetsAddressUint168)
	if err != nil {
		return nil, err
	}
	...
	outputs := []*common.OutputInfo{{*b.chainParams.CRConfiguration.CRAssetsAddressUint168,
		rectifyAmount}}

	tx, err := b.createTransaction(&payload.CRAssetsRectify{}, common.CRAssetsRectify,
		*b.chainParams.CRConfiguration.CRAssetsAddressUint168,
