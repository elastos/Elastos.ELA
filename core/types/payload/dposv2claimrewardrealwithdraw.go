...
const DposV2ClaimRewardRealWithdrawVersion byte = 0x00

type DposV2ClaimRewardRealWithdraw struct {
	// Hash of the proposal to withdrawal ela.
	WithdrawTransactionHashes []common.Uint256
}

func (p *DposV2ClaimRewardRealWithdraw) Data(version byte) []byte {
...
func (p *DposV2ClaimRewardRealWithdraw) Serialize(w io.Writer, version byte) error {
...
func (p *DposV2ClaimRewardRealWithdraw) Deserialize(r io.Reader, version byte) error {
