...
func TestAddLocalAddress(t *testing.T) {
	var tests = []struct {
		address  p2p.NetAddress
		priority addrmgr.AddressPriority
		valid    bool
	}{
		{
			p2p.NetAddress{IP: net.ParseIP("192.168.0.100")},
			addrmgr.InterfacePrio,
			false,
		},
		{
			p2p.NetAddress{IP: net.ParseIP("204.124.1.1")},
			addrmgr.InterfacePrio,
			true,
		},
		{
		...
		{
			p2p.NetAddress{IP: net.ParseIP("::1")},
			addrmgr.InterfacePrio,
			false,
		},
		{
			p2p.NetAddress{IP: net.ParseIP("fe80::1")},
			addrmgr.InterfacePrio,
			false,
		},
		{
			p2p.NetAddress{IP: net.ParseIP("2620:100::1")},
			addrmgr.InterfacePrio,
			true,
		},
	}
...
func TestNeedMoreAddresses(t *testing.T) {
	...
	srcAddr := p2p.NewNetAddressIPPort(net.IPv4(173, 144, 173, 111), 8333, 0)
...
func TestGetBestLocalAddress(t *testing.T) {
	...
	var tests = []struct {
		remoteAddr p2p.NetAddress
		want0      p2p.NetAddress
		want1      p2p.NetAddress
		want2      p2p.NetAddress
		want3      p2p.NetAddress
	}{
		{
			// Remote connection from public IPv4
			p2p.NetAddress{IP: net.ParseIP("204.124.8.1")},
			p2p.NetAddress{IP: net.IPv4zero},
			p2p.NetAddress{IP: net.IPv4zero},
			p2p.NetAddress{IP: net.ParseIP("204.124.8.100")},
			p2p.NetAddress{IP: net.ParseIP("fd87:d87e:eb43:25::1")},
		},
		{
			// Remote connection from private IPv4
			p2p.NetAddress{IP: net.ParseIP("172.16.0.254")},
			p2p.NetAddress{IP: net.IPv4zero},
			p2p.NetAddress{IP: net.IPv4zero},
			p2p.NetAddress{IP: net.IPv4zero},
			p2p.NetAddress{IP: net.IPv4zero},
		},
		{
			...
			p2p.NetAddress{IP: net.ParseIP("2602:100:abcd::102")},
			p2p.NetAddress{IP: net.IPv6zero},
			p2p.NetAddress{IP: net.ParseIP("2001:470::1")},
			p2p.NetAddress{IP: net.ParseIP("2001:470::1")},
			p2p.NetAddress{IP: net.ParseIP("2001:470::1")},
		},
		/* XXX
		{
			...
			p2p.NetAddress{IP: net.ParseIP("fd87:d87e:eb43::100")},
			p2p.NetAddress{IP: net.IPv4zero},
			p2p.NetAddress{IP: net.ParseIP("204.124.8.100")},
			p2p.NetAddress{IP: net.ParseIP("fd87:d87e:eb43:25::1")},
		},
	...
	localAddr := p2p.NetAddress{IP: net.ParseIP("204.124.8.100")}
	amgr.AddLocalAddress(&localAddr, addrmgr.InterfacePrio)
	...
	/*
		...
		localAddr = p2p.NetAddress{IP: net.ParseIP("fd87:d87e:eb43:25::1")}
