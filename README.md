...
- [Pre-requisites on Mac](#pre-requisites-on-mac)
    ...
    - [2. Install Go distribution 1.9](#2-install-go-distribution-1-9)
...
- [Pre-requisites on Ubuntu](#pre-requisites-on-ubuntu)
    ...
    - [3. Install Go distribution 1.9](#3-install-go-distribution-1-9)
...
- [Build the node](#build-the-node)
    ...
    - [3. Check Go version and glide version](#4-check-go-version-and-glide-version)
    - [4. Clone source code to $GOPATH/src/github/elastos folder](#5-clone-source-code-to-gopath-src-github-elastos-folder)
    - [5. Install dependencies using Glide](#6-install-dependencies-using-glide)
    - [6. Make](#7-make)
    - [7. Run the node on Mac](#8-run-the-node-on-mac)
